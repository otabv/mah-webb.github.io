...
I tidigare exempel har vi nyttjat `class` och _element_ selektorn för att applicera en stilmall på flera element. Ytterliggare ett alternativ till detta är att använda arv. Detta sker genom att ett element som placeras i ett annat element ärver stilmallen från förälder elementet.
{: .info}
