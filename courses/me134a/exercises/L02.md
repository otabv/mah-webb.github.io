...
I tidigare exempel har vi nyttjat `class` och _element_ selektorn för att applicera en stilmall på flera element. Ytterliggare ett alternativ till detta är att använda arv. Detta sker genom att element som placeras i ett annat element (eng. nesting) ärver stilmallen från förälder elementet.
{: .info}
...
{% highlight css linenos %}
/*
    Alla synliga element placeras i <body>, därför kan
    vi enkelt bestämma typsnitt m.m. för alla dessa samtidigt.
*/
body {
    /*
