...
* Ta reda på hur ni kan applicera en stilmall på __en__ kolumn i en tabell. Detta utan att e.g. applicera en CSS klass på dessa tabellceller. Tips: `<colgroup>`.
