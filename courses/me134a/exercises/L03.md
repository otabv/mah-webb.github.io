...
I våran mall börjar vi med vår `<div class="row">` som representerar en rad på vår sida. I denna rad har vi våra tre kolumner med varsin paragraf. Anledning till att jag valt att döpa klasserna till "columns-4" är att om vi har en 12-kolumns-layout och vi har tre kolumner kommer varje kolumn sträcka sig över fyra layout kolumner. Detta är med stor sannolikhet ganska förvirrande men ta en titt på Figur 4 och observera namnen på klasserna och hur de relaterar till layout kolumnerna (grå).
...
Formeln för att räkna ut den bredd som anges i CSS är följande (förutsatt en bredd på 960 pixlar): `80 * (antal gråa staplar) - (margin + padding + border)`. Testa uträknaren nedan för att se hur det fungerar.
{: .info}

<form id="grid-calculator" action="" method="GET">
    <span class="grid-column">80</span>
...
gridsystem, ramverk, % baserade bredder?
