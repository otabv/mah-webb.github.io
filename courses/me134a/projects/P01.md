...
Syftet med projektet är att introducera studenten till att arbeta med projekt i gruppform. Därmed får studenten en chans till att applicera tidigare kunskap i ett större omfång, men även en inblick i hur projektmetoder används för att föra utvecklingen av en produkt framåt.

## Projekt

Detta projekt kommer att utföras i grupper om 4 till 6 personer. Grupperna kommer bestå av cirka 2 - 3 studenter från [Webbpublicering][webbpublicering] samt 2 - 3 studenter från [Webbproduktion][webbproduktion]. Indelning av grupper kommer publiceras på [It's learning][itslearning]. Eftersom ni kommer vara studenter från olika utbildningar är det viktigt att utnyttja varandras kompetenser så mycket som möjligt.
...
Även invånarantalet på Bornholm minskar konstant, 1965 nåddes toppen med dryga 48 600 invånare men har minskat varje år sedan dess. Numera invånarantalet nere på cirka 42 500. Detta är en trend som Bornholms Regionskommune naturligtvis vill bryta. Med tanke på det geografiska läget och förbindelserna med fastlandet vill man främst satsa på att få dit svenska medborgare.
...
Under hela projektets gång har ni givetvis möjlighet att ställa hur mycket frågor ni vill.

#### Projektplan

Alla projektdeltagare ska på något sätt vara involverade i samtliga delar av projektplanen. Tanken är att ni tillsammans i gruppen ska diskutera och konceptutveckla er idé och ert projekt. De delar som ska inkluderas i projektplanen är följande:
...
* __Webbplatsen__ - hur fungerade arbetsprocessen? blev slutresultatet vad ni förväntat er?
