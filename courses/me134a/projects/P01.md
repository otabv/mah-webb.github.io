...
Ni ska föra en löpande budget för projektet via metoden - [Earned Value Analysis][eva]. Tre gånger under projektets gång ska ni rapportera in ovanstående analys. På så sätt kommer vi se er progression allt eftersom. Earned Value Analysis ger information som kan svara på frågorna; håller budgeten och kommer vi hålla deadline. Webbproduktionsstudenterna kommer få en föreläsning och ett seminarium angående just dessa delar. Det är också webbproduktionsstudenterna som får det övergripande ansvaret över projektets ekonomiska delar.

Mall för ekonomiskt underlag finner ni [här][ekonomi].
