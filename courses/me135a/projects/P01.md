...
[Trello][trello] är ett projektledningsverktyg som samtliga deltagare ska vara aktiva på. Bjud därmed in oss lärare (johanneskarlsson och sebastianbengtegard). Trello finns även som app för både iOS och Android. Hur ni väljer att organisera arbetet är upp till gruppen.
...
Ni ska använda er av WordPress eller HTML/CSS för att utforma er webbplats. Webbplatsen ska vara komplett, vilket innebär att ni måste författa egna texter och använda er av de bilder vi tillhandahåller eller producera egna (tänk på copyright). Se kraven nedan:
...
Reflektionen ska ha en omfattning på max fyra A4-sidor. Tänk på att inkludera vilken grupp ni ingår i.
