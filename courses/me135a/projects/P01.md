...
Ekonomiskt underlag finner ni [här][ekonomi].
...
Under hela projektets gång har ni givetvis möjlighet till att ställa frågor. Om detta skers via epost var då noga med att utse en i gruppen som ansvarar för detta.
...
Inför projektpresentationen ska ert projektdokument lämnas in (vidarutveckling av er projektplan), här kan det vara bra att tänka på:
...
[ekonomi]: /assets/pdf/ekonomi_underlag.pdf
