...
En URL är en unik adress som pekar till en resurs (webbplats, PDF, Bild, osv.) på webben. Dessa URL:er är viktiga för att användaren ska hitta rätt. För att underlätta för användbarheten bör dessa ha logiska och enkla namn.

* Bra - `http://supersidan.se/kontakt`
* Dåligt - `http://supersidan.se/?page=14`
