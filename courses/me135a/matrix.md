...
| Kriterium           | Underkänt                                                              | Godtagbart                                                                                                                           | Bättre                                                                                                                     |
| -----------         | -----------                                                            | ------------                                                                                                                         | --------                                                                                                                   |
| **Målgrupp**        | Målgruppen presenteras ytligt utan förståelse för användbarhet.        | Målgruppen är tydligt avgränsad och kopplas till användbarhetsfaktorer.                                                              | Ett tydligt resonemang förs över webbplatsens användbarhet och olika lösningar diskuteras.                                 |
| **Syfte**           | Syftet bearbetas ytligt utan förståelse för användbarhetsteori.        | Syftet presenteras och kopplas till användbarhetsteori.                                                                              | Syftet presenteras och analyseras utifrån användbarhetsteori med en förståelse för både avsändarens och besökarens syfte.  |
| **Teknik**          | Koden genomgår inte W3Cs validerings verktyg.                          | Koden godkänds av W3Cs validerings verktyg.                                                                                          |                                                                                                                            |
...
| **Teorianknytning** | Ingen eller otydlig koppling till teori.                               | Tydlig koppling till relevant teori.                                                                                                 | Studenten använder flera referenser som kritiskt analyseras.                                                               |
| **Reflektion**      | Studenten presenterar endast sitt tillvägagångssätt.                   | Texten uppnår en reflekterande nivå som visar på att studenten har förstått utförande samt vilka lärdomar som kan dras av processen. | Resonemangen når en högre nivå.                                                                                            |
{: .small}
